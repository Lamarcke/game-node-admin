      ...
      <Card.Section style={sectionStyle}>
        <Stack gap={1}>
          ...
          <Text fz="sm" c="dimmed" fw="500">
            Activities include most actions performed by users, e.g.: adding a
            game to a collection, creating a review, following a user, etc.
          </Text>
        </Stack>
      </Card.Section>
      <Card.Section style={sectionStyle}>
...
export default ActivityByPeriodSection;
